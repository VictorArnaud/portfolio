let info = {
    ...
    description: [
        ...
        "Knowledge in requirements analysis, process modeling, software quality, project management using agile methodology, work with mobile and web development with emphasis on python and javascript technologies that I would like to specialize, always aiming at best practices for software development. I have no problem learning new technologies if needed. I strive to improve my knowledge for better results and to ensure the quality of the product.",
        "I always try to work as a team, with great satisfaction in teaching and learning any knowledge, helping to generate solutions for the company, meeting the objectives in the area in which it is assigned, also seeking professional development.",
        "I am proactive, communicative, focused and punctual, I adapt to different routines and face any challenge as a great opportunity to develop my knowledge and always achieve positive results, I seek to understand what I did wrong and what I can improve, I look for a company that Allow for my intellectual and technical growth, so I can contribute to it for a long time as we grow together."
    ],
    skills: {
    ...
    projects: [
        {
            ...
            description: "PGTBL is a platform to manage and apply the Team-based learning or TBL methodology that is a collaborative learning teaching strategy that focuses on a three-step cycle: Preparation, Class evaluations and Small project focused on the application"
        },
        {
            id: "softeng",
        ...
        },
        {
            ...
            description: "Information tool and union of people living with Down Syndrome. Dr. Down is a system aimed at assisting the care of people with Down Syndrome currently performed by the Regional Hospital of Asa Norte, located in Brasilia - DF, in a specialized treatment center called Cris Down."
        },
        {
            id: "pigeon",
    ...
    experience: [
        ...
        },
        {
            ...
            time: "2018 - 2019",
            description: [
                "Development of a tool to cost government services before and after digital transformation to Ministry of planning using technologies like Spring Boot and Angular 6 and worked in the area devops for some time creating the pipeline of continuous integration and continuous deploy of software."
            ]
        },
        {
            company: "Embrapa",
            ...
            time: "2016",
            description: [
                "Certificate of participation of the first Hackathon of the company Embrapa, a Brazilian company of agricultural research, developing a solution within the theme: Integrated pest management for the sustainability of agroecosystems, being among the top 8 of the competition."
            ]
        },
        {
            ...
            time: "2016 - 2017",
            description: [
                "Lappis is a laboratory of the campus of engineering of the gama that takes care mainly of maintenance and evolution of free software. I worked in the software maintenance and evolution team, Gestorpsi, in the back-end and front-end, improving my knowledge in Django, using agile methodologies such as Scrum and XP."
            ]
        },
        {
            company: "UnB",
            ...
            time: "2014 - 2019",
            description: [
                "<b>Student Mentor (2018)</b>: Mentor in the discipline software metering and analysis in the university of brasilia, campus of engineering UnB-Gama.",
                "<b>Student Mentor (2018)</b>: Mentor in the discipline Software Testing and Software Development Methodology in the university of brasilia, campus of engineering UnB-Gama",
                "<b>Student Mentor (2017)</b>: Mentor in the discipline APC - Programming algorithms for computers in the university of brasilia, campus of engineering UnB-Gama",
                "<b>Student Mentor (2016)</b>: Basic Computer Monitoring in which it helps the students of the discipline to program in the C language",
                "<b>Taekwondo Teacher (2014 - 2017)</b>: Teacher of taekwondo, black belt 1 ° dan at the university of brasília on the campus of engineering of the gama, project culture and leisure.",
                "<b>Sports and Events (2014 - 2015)</b>: I helped DA to organize university sports and events in the university of brasilia, campus of engineering UnB-Gama."
            ]
        }
    ]
}